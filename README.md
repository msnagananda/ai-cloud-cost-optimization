...
## Disclaimer: 
The core source code originates from Abhishek Veermala's project. I have reused it to demonstrate deployment and execution on AWS Cloud, making only minimal changes to prompts and cloud-specific configurations.
